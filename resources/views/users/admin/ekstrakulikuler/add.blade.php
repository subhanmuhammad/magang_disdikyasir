  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/ekstrakulikuler" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Ekstrakulikuler</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/ekstrakulikuler/store" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="nama_ekstrakulikuler" type="text" class="form-control" placeholder="Masukan Nama Ekstrakulikuler" required>
          </div>
        </div>
