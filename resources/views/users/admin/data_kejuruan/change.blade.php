...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Kejuruan</h3>
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/data_kejuruan" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Guru</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_kejuruan/update" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama Jurusan</label>
            <input type="text" name="id" value="{{$data_kejuruan->id}}" hidden>
            <input name="nama_jurusan" type="text" class="form-control" value="{{$data_kejuruan->nama_jurusan}}" required>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="keterangan" type="text" class="form-control" value="{{$data_kejuruan->keterangan}}" required>
          </div>
        </div>
