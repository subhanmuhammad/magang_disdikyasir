  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/data_kejuruan" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Jurusan</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_kejuruan/store" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="nama_jurusan" type="text" class="form-control" placeholder="Masukan nama jurusan" required>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="keterangan" type="text" class="form-control" placeholder="Masukkan Keteragan" required>
          </div>
        </div>
      </div>
      <hr>
