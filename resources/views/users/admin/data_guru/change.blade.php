...
<div class="card">
  ...
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_guru/update" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama dan Gelar</label>
            <input type="text" name="id" value="{{$data_guru->id}}" hidden>
            <input name="nama" type="text" class="form-control" placeholder="Masukan nama guru" value="{{$data_guru->nama}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>NIP</label>
            <input name="nip" type="number" class="form-control" placeholder="Masukkan NIP" value="{{$data_guru->nip}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Jabatan</label>
            <input name="jabatan" type="text" class="form-control" placeholder="Masukkan Jabatan" value="{{$data_guru->jabatan}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Tempat Lahir</label>
            <input name="tempat_lahir" type="text" class="form-control" placeholder="Masukkan Tempat Lahir" value="{{$data_guru->tempat_lahir}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Tanggal Lahir</label>
            <input name="tanggal_lahir" type="date" class="form-control" placeholder="Masukkan Tanggal Lahir" value="{{$data_guru->tanggal_lahir}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="mata_pelajaran" type="text" class="form-control" placeholder="Guru Mata Ppelajaran" value="{{$data_guru->mata_pelajaran}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Masa Kerja</label>
            <input name="masa_kerja" type="text" class="form-control" placeholder="Masukkan Masa kerja" value="{{$data_guru->masa_kerja}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Pendidikan Terakhir</label>
            <input name="pendik_terakhir" type="text" class="form-control" placeholder="Masukkan Pendidikan Terakhir" value="{{$data_guru->pendik_terakhir}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Alamat</label>
            <input name="alamat" type="text" class="form-control" placeholder="Masukkan Alamat" value="{{$data_guru->alamat}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>No. Hp/Telpon</label>
            <input name="no_hp" type="number" class="form-control" placeholder="Masukkan No. Hp/Telpon" value="{{$data_guru->no_hp}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
