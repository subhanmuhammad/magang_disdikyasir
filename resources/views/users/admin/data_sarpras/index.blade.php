  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url()->current()}}/add" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Tambah Sarana Prasarana</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <table id="datatable" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$row->sarpras_jenis_id}}</td>
          <td>{{$row->jumlah}}</td>
          <td>
            <img src="{{ asset('/public/img/'.$row->gambar) }}"  height="30%" width="30%" alt="" >
          </td>
