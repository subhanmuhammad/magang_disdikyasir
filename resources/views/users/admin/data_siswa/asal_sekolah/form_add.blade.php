      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="nomor_seri_ijazah" type="text" class="form-control" placeholder="" required>
          </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="nomor_seri_skhun" type="number" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="nomor_ujian_nasional" type="number" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="npsn_sekolah_asal" type="number" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="nama_sekolah_asal" type="text" class="form-control" placeholder="" required >
            </div>
          </div>      
