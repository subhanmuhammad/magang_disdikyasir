      ...
      <div class="row">          
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input name="tinggi_badan" type="text" class="form-control" placeholder="" required>
          </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="jarak_tempat_tinggal" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="waktu_tempuh" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="jumlah_saudara_kandung" type="text" class="form-control" placeholder="" required >
            </div>
          </div>        
      </div>
      <hr>
