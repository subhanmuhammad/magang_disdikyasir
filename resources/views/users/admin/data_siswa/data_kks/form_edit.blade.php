...
<div class="card">
  ...
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url()->current()}}/updated" method="post">
      {{csrf_field()}}
      <input name="id" type="hidden" value="{{ $kks->id }}">
      <div class="row">  
        <div class="col-md-6">
          <div class="form-group">
            <label>No KKS</label>
            <input name="kks_no" type="text" class="form-control" placeholder="" required value="{{ $ortu->ayah_nama }}">
          </div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="pip_alasan" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="no_akta_lahir" type="text" class="form-control" placeholder="" required >
          </div>
        </div>
