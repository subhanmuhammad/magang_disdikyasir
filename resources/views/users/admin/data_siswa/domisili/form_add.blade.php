...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">TAMBAH DOMISILI</h3>
    ...
    <form class="striped-rows" enctype="multipart/form-data" action="{{url()->current()}}/store" method="post">
      ...
      <div class="row">    
        ...
        <div class="col-md-6">
            <div class="form-group">
              <label>Dusun</label>
              <input name="dusun" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="kelurahan" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="kecamatan" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="kab_kota_id" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="transportasi_id" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="jenis_tinggal_id" type="text" class="form-control" placeholder="" required >
            </div>
          </div>
