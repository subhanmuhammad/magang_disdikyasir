  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/data_arsip" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Guru</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_arsip/store" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama</label>
            <input name="nama_arsip" type="text" class="form-control" placeholder="Masukan nama guru" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Sekolah</label>
            <input name="sekolah_id" type="text" class="form-control" placeholder="" required>
          </div>
        </div>
      </div>
      <hr>
