...
<div class="card">
  ...
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_arsip/update" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama</label>
            <input type="text" name="id" value="{{$data_arsip->id}}" hidden>
            <input name="nama" type="text" class="form-control" placeholder="Masukan nama guru" value="{{$data_arsip->nama}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
