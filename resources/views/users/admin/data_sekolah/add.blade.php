  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/data_sekolah" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Sekolah</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/data_sekolah/store" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
