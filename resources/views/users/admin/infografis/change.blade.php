  ...
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm">
        <a href="{{url('/')}}/admin/infografis" class="btn btn-warning"><i class="fa fa-chevron-left"></i>&nbsp;Daftar Guru</a>
      </div>
    </div>
  </div>
  <div class="card-body">
    <form class="striped-rows" enctype="multipart/form-data" action="{{url('/')}}/admin/infografis/update" method="post">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama</label>
            <input type="text" name="id" value="{{$infografis->id}}" hidden>
            <input name="nama" type="text" class="form-control" placeholder="Masukan nama guru" value="{{$infografis->nama}}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
