<?php
  $curl = curl_init();
  curl_setopt($curl, CURLOPT_URL, 'http://localhost/websekolah_adminsekolah_master/api/ekskul');
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <p class="justify">Ada banyak kegiatan ekskul yang bisa diikuti di SMK NEGERI 1 PALU untuk mengasah bakat kamu, misalnya saja; Pramuka, PMR, Paskibraka, Marching Band, Catur, KIR, Tari Tradisional Photografi dll.</p>
          <hr>
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Semua</li>
              <li data-filter=".filter-Pramuka">Pramuka</li>
              <li data-filter=".filter-PMR">PMR</li>
              <li data-filter=".filter-Paskibraka">Paskibraka</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-<?= $row["nama_ekstrakulikuler"]; ?>">
            <div class="portfolio-wrap border-radius">
              <img src="<?= $row["link"]; ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <div class="portfolio-links">
                  <a href="<?= $row["link"]; ?>" data-gallery="portfolioGallery" class="portfokio-lightbox" title="<?= $row["nama_ekstrakulikuler"]; ?>"><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
