        ...
        <div class="card shadow p-3" data-aos="fade-center">
          <div class="card-body">
            <div class="row">
              <div class="col-lg-6">
                <h2>Visi :</h2>
                <p class="justify">Menjadi Smk Yang Berkualitas Unggul Berdasarkan Imtaq & Iptek Serta Menghasilkan Tamatan Yang Mampu Bersaing Ditingkat Nasional & Internasional.</p>
              </div>
              <div class="col-lg-6">
                <h2>Misi :</h2>
                <ol class="justify">
                  <li>Mengembangkan Iklim Belajar Yang Berdasarkan Pada Nilai-Nilai Agama Serta Norma Budaya Bangsa</li>
                  <li>Menyelenggarakan & Mengembangkan Pendidikan Bagi Peserta Didik Yang Profesional Berstandar Nasional & Internasional</li>
                  <li>Mengembangkan Sistem Pendidikan & Pelatihan Yang Fleksibel & Berwawsan Global</li>
                  <li>Meningkatkan Profesionalisme Tenaga Pendidik & Tenaga Kependidikan</li>
                  <li>Menyiapkan Tamatan Yang Memiliki Pengetahuan & Keterampilan</li>
                  <li>Meningkatkan Peran Serta Masyarakat Dalam Penyelenggaraan Pendidikan</li>
                </ol>
              </div>
            </div>
          </div>
